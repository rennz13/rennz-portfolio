          ...
          >
            ...
            <div className="flex flex-wrap gap-1 md:gap-1.5">
              {interests.map((interest, i) => (
                <span
                  key={i}
                  className="px-1.5 py-0.5 md:px-2.5 md:py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-[10px] md:text-xs lg:text-sm font-medium"
                >
                  {interest}
                </span>
              ))}
